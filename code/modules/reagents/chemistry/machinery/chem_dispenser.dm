...
/obj/machinery/chem_dispenser/soda
	...
	upgrade_reagents = list("bananahonk", "milkshake", "cafe_latte", "cafe_mocha", "triple_citrus", "icecoffe","icetea", "raspberryjuice", "cranberryjuice")
...
/obj/machinery/chem_dispenser/beer
	...
	dispensable_reagents = list("ice", "cream", "cider", "beer", "darkbeer", "kahlua", "whiskey", "wine", "whitewine", "vodka", "gin", "rum", "tequila", "vermouth", "cognac", "ale", "mead", "synthanol")
